...
if __name__ == '__main__':
    ...
    conv_1 = Conv3D(filters=256, kernel_size=(3, 3, 3), strides=(1, 1, 1), padding='same')(input_lay)
    nor_1 = BatchNormalization()(conv_1)
    act_1 = Activation('relu')(nor_1)
    maxp_1 = MaxPooling3D(pool_size=(2, 2, 2))(act_1)

    conv_2 = Conv3D(filters=512, kernel_size=(3, 3, 3), strides=(1, 1, 1), padding='same')(maxp_1)
    nor_2 = BatchNormalization()(conv_2)
    act_2 = Activation('relu')(nor_2)
    maxp_2 = MaxPooling3D(pool_size=(2, 2, 2))(act_2)

    conv_3 = Conv3D(filters=1024, kernel_size=(3, 3, 3), strides=(1, 1, 1), padding='same')(maxp_2)

...
if __name__ == '__main__':
    ...
    conv_1 = Conv3D(filters=24, kernel_size=(3, 3, 3), strides=(1, 1, 1), padding='same')(input_lay)
    ...
    conv_3 = Conv3D(filters=64, kernel_size=(3, 3, 3), strides=(1, 1, 1), padding='same')(maxp_2)

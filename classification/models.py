...
def get_simple_VoxCNN(config):
    ...
    conv_1 = Conv3D(filters=8, kernel_size=(3, 3, 3), padding='same')(input_lay)
    act_1 = Activation('relu')(conv_1)
    conv_2 = Conv3D(filters=8, kernel_size=(3, 3, 3), padding='same')(act_1)
    act_2 = Activation('relu')(conv_2)
    maxp_2 = MaxPooling3D(pool_size=(2, 2, 2), padding='same')(act_2)
    conv_3 = Conv3D(filters=16, kernel_size=(3, 3, 3), padding='same')(maxp_2)
    act_3 = Activation('relu')(conv_3)
    conv_4 = Conv3D(filters=16, kernel_size=(3, 3, 3), padding='same')(act_3)

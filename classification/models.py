...
def get_simple_VoxCNN(config):
    ...
    conv_1 = Conv3D(filters=8, kernel_size=(3, 3, 3), padding='same', kernel_regularizer=l2(0.005), bias_regularizer=l2(0.005))(input_lay)
    act_1 = Activation('relu')(conv_1)
    conv_2 = Conv3D(filters=8, kernel_size=(3, 3, 3), padding='same', kernel_regularizer=l2(0.005), bias_regularizer=l2(0.005))(act_1)
    act_2 = Activation('relu')(conv_2)
    maxp_2 = MaxPooling3D(pool_size=(2, 2, 2))(act_2)
    conv_3 = Conv3D(filters=16, kernel_size=(3, 3, 3), padding='same', kernel_regularizer=l2(0.005), bias_regularizer=l2(0.005))(maxp_2)
    act_3 = Activation('relu')(conv_3)
    conv_4 = Conv3D(filters=16, kernel_size=(3, 3, 3), padding='same', kernel_regularizer=l2(0.005), bias_regularizer=l2(0.005))(act_3)
    act_4 = Activation('relu')(conv_4)
    maxp_4 = MaxPooling3D(pool_size=(2, 2, 2), padding='same')(act_4)
    flat = Flatten()(maxp_4)
    den_5 = Dense(units=128, kernel_regularizer=l2(0.005), bias_regularizer=l2(0.005))(flat)
    act_5 = Activation('relu')(den_5)
    # nor_5 = BatchNormalization()(act_5)
    drop_5 = Dropout(0.4)(act_5)
    den_6 = Dense(units=64, kernel_regularizer=l2(0.005), bias_regularizer=l2(0.005))(drop_5)
